...
#define PACKAGE_STRING "Libtasn1 (for GNU Emacs)"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "libtans1-4.19.0-emacs"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://gnu.org/software/emacs"

/* Define to the version of this package. */
#define PACKAGE_VERSION "4.19.0 (Emacs)"
...
/* #undef SIZEOF_UNSIGNED_LONG_INT defined by Android.mk */

/* Define to l, ll, u, ul, ull, etc., as suitable for constants of type
   'size_t'. */
#define SIZE_T_SUFFIX "zu"
